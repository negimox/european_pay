        ...
        <section className="hidden lg:flex flex-col justify-between w-1/2 p-[64px] relative bg-surface-container-lowest">
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-[80px]">
              ...
              <span className="font-headline-lg text-headline-lg text-primary">UniEvent</span>
            </div>
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant mt-[24px] max-w-md">
              Access events, clubs, and resources all in one place. Stay in the pulse of university life.
            </p>
          </div>
          {/* Image Container */}
        ...
        <section className="w-full lg:w-1/2 flex items-center justify-center p-[16px] md:p-[64px] bg-surface-container-lowest relative z-20 overflow-y-auto">
          <div className="w-full max-w-[420px] bg-surface-container-lowest rounded-lg p-[48px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-outline-variant/20 relative">
            ...
            <div className="flex lg:hidden items-center gap-2 mb-[48px] justify-center">
              <Image src="/web-app-manifest-512x512.png" alt="UniEvent Logo" width={28} height={28} />
              <span className="font-headline-md text-headline-md text-primary">UniEvent</span>
            </div>
            
            <div className="mb-[80px] text-center">
              <h2 className="font-headline-lg text-headline-lg text-on-surface">Welcome Back</h2>
              <p className="font-body-md text-body-md text-on-surface-variant mt-[12px]">Please sign in to your account.</p>
            </div>
            ...
            <form action={formAction} className="flex flex-col gap-[24px]">
              ...
              <div>
                <div className="flex justify-between items-center mb-[4px]">
                  ...
                  <Link href="#" className="font-label-sm text-label-sm text-primary hover:text-primary-container transition-colors">
                    Forgot Password?
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="mt-[80px] text-center">
              <p className="font-body-md text-body-md text-on-surface-variant">
                ...
                <Link className="text-primary font-label-md text-label-md hover:underline" href="/register">
                  Register here
                </Link>
              </p>
            </div>
